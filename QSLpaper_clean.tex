...
\hypersetup{
 pdftitle = {Controlling atomic wave packets at the quantum speed limit},
...
\title{Controlling atomic wave packets at the quantum speed limit\\ % Andrea, Wolfgang
...
\title{Controlling atomic wave packets at the quantum speed limit}
...
%
Ultimately, however, quantum mechanics sets limits on the shortest time required to carry out a quantum process with unity fidelity, which depends on the distance between the initial and final state, and on the energy available to control the process.
%
